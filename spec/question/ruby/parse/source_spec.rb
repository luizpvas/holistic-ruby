...
describe ::Question::Ruby::Parse::Source do
  describe "module declaration in the global namespace" do
  ...
  describe "module declaration in global scope with double colon syntax" do
    subject(:parse_source) { described_class.call(application:, source:) }
  ...
  describe "module declaration with nested syntax" do
    subject(:parse_source) { described_class.call(application:, source:) }
  ...
  describe "module declaration with nested syntax AND double colon syntax" do
    subject(:parse_source) { described_class.call(application:, source:) }
