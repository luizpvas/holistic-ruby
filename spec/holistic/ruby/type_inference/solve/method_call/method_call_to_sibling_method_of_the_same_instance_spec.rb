...
describe ::Holistic::Ruby::TypeInference::Solve do
  ...
  context "when calling a method in the same class" do
    ...
    it "solves the method call reference" do
      ...
      expect(reference.has_one(:referenced_scope).fully_qualified_name).to eql("::Calculator#sum")
    end
  end
  ...
  context "when calling a private method in the same class" do
    ...
    it "solves the method call reference" do
      ...
      expect(reference.has_one(:referenced_scope).fully_qualified_name).to eql("::EventsController#search_events_from_request_params")
    end
  end
end
