  ...
  describe "#store" do
    context "when file does not exist in the repository" do
      it "stores a file indexed by the path" do
        ...
        file = ::Holistic::Document::File.new(path: "/my_app/file.rb")
    ...
    context "when file already exists" do
      it "updates the existing record" do
        ...
        file_1 = ::Holistic::Document::File.new(path: "/my_app/file.rb")
        file_2 = ::Holistic::Document::File.new(path: "/my_app/file.rb")
